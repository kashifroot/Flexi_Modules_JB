...
class Pos_promotion(models.Model):
    ...
    pos_quantity_fixed_ids = fields.One2many('quantity.discount.fixed', 'pos_quantity_fixed_rel')
...
class quantity_discount(models.Model):
    ...
    operator = fields.Selection([('equal', '='), ('equal_or_greater', '>='), ('greater', '>')], required=True,
                                default='equal')
...
class Discount_On_Above_Price(models.Model):
    ...
    product_brand_ids = fields.Many2many('product.brand.flexi', 'product_brand_rel', string="Product Brands")
    free_product = fields.Many2one('product.product', string="Product")

class Discount_On_Above_Price(models.Model):
    _name = 'quantity.discount.fixed'

    pos_quantity_fixed_rel = fields.Many2one('pos.promotion')
    discount = fields.Float("Discount (RM)")
