...
class trial_balance_wiz(models.TransientModel):
    ...
    def print_pdf(self, data):
        ...
        return self.env.ref('flexiretail_advance.report_trial_balance').report_action(self, data=datas)
    ...
    def print_xls(self):
        ...
        report_obj = self.env['report.flexiretail_advance.trial_balance_template']
        styleP = xlwt.XFStyle()
