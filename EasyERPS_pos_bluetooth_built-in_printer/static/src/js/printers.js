odoo.define('EasyERPS_pos_bluetooth_built-in_printer.Printer', function (require) {
"use strict";
...
var PrinterMixin = {
    ...
    htmlToImg: function (receipt) {
        ...
        var promise = new Promise(function (resolve, reject) {
            self.receipt = $('.pos-receipt-print>.pos-sale-ticket');
    ...
    htmlToImgreceipt: function (receipt) {
        var self = this;
        $('.pos-receipt-print').html(receipt);
        var promise = new Promise(function (resolve, reject) {
            self.receipt = $('.pos-receipt-print>.pos-sale-ticket');
    ...
    htmlToImgrereceipt: function (receipt) {
        var self = this;
        $('.pos-receipt-print').html(receipt);
        var promise = new Promise(function (resolve, reject) {
            self.receipt = $('.pos-receipt-print>.pos-sale-ticket');
