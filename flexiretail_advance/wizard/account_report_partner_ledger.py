...
class AccountPartnerLedger(models.TransientModel):
    ...
    def generate_partner_ledger(self, data):
        ...
        return self.env.ref('flexiretail_advance.report_partner_ledger').report_action(self, data=datas)

    def print_xls(self):
        report_obj = self.env['report.flexiretail_advance.partner_ledger_template'].with_context(
