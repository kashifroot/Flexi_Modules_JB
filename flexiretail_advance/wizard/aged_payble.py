...
class AccountAgedReceivable(models.TransientModel):
    ...
    def generate_aged_payble(self):
        ...
        return self.env.ref('flexiretail_advance.report_aged_payble').report_action(self, data=datas)

    @api.multi
    def generated_aged_payable_xls(self):
        report_obj = self.env['report.flexiretail_advance.aged_payble_template']
        styleP = xlwt.XFStyle()
