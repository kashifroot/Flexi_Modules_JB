...
class LoyaltyConfiguration(models.TransientModel):
    ...
    def load_loyalty_config_settings(self):
        ...
        settings_minimum_purchase = self.env['ir.config_parameter'].sudo().search(
            [('key', '=', 'flexiretail_advance.minimum_purchase')])
        ...
        settings_points_based_on = self.env['ir.config_parameter'].sudo().search(
            [('key', '=', 'flexiretail_advance.points_based_on')])
        ...
        settings_point_calculation = self.env['ir.config_parameter'].sudo().search(
            [('key', '=', 'flexiretail_advance.point_calculation')])
    ...
    def get_values(self):
        ...
        res.update({
            'points_based_on': param_obj.sudo().get_param('flexiretail_advance.points_based_on'),
            'minimum_purchase': float(param_obj.sudo().get_param('flexiretail_advance.minimum_purchase')),
            'point_calculation': float(param_obj.sudo().get_param('flexiretail_advance.point_calculation')),
            'points': int(param_obj.sudo().get_param('flexiretail_advance.points')),
            'to_amount': float(param_obj.sudo().get_param('flexiretail_advance.to_amount')),
        })
        return res
    ...
    def set_values(self):
        ...
        param_obj = self.env['ir.config_parameter']
        param_obj.sudo().set_param('flexiretail_advance.points_based_on', self.points_based_on)
        param_obj.sudo().set_param('flexiretail_advance.minimum_purchase', float(self.minimum_purchase))
        param_obj.sudo().set_param('flexiretail_advance.point_calculation', float(self.point_calculation))
        param_obj.sudo().set_param('flexiretail_advance.points', int(self.points))
        param_obj.sudo().set_param('flexiretail_advance.to_amount', float(self.to_amount))
        return res
