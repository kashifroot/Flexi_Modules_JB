...
class AccountingReport(models.TransientModel):
    ...
    def check_report(self):
        ...
        data = {}
        data['form'] = \
            self.read(['account_report_id', 'date_from_cmp', 'date_to_cmp', 'journal_ids', 'filter_cmp', 'target_move',
                       'company_id'])[0]
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('flexiretail_advance.action_report_financial').report_action(self, data=data,
                                                                                             config=False)

    def print_xls(self):
        report_obj = self.env['report.flexiretail_advance.report_financial']
        data = {}
        data['form'] = \
            self.read(
