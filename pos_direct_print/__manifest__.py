...
#################################################################################
{
    ...
    "summary":  """The POS Print Direct: Single Click Print module simplifies the process of printing POS receipts with any printer—thermal, PDF, or image printers—directly from Odoo. It eliminates the need for downloads or extra steps, ensuring a seamless printing experience. Receipt printing is fully compatible with multiple languages, including Arabic, French, German, Spanish, Italian, Dutch, and others, enabling global businesses to print POS receipts in their preferred language. The module also supports remote printing and printing from mobile devices, tablets, Android, and iOS, providing flexibility for businesses on the go.
