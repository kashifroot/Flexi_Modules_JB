...
class AccountAgedReceivable(models.TransientModel):
    ...
    def generate_aged_receivable(self):
        ...
        return self.env.ref('flexiretail_advance.report_aged_receivable').report_action(self, data=datas)

    @api.multi
    def generate_account_receivable_xls(self):
        report_obj = self.env['report.flexiretail_advance.aged_receivable_template']
        styleP = xlwt.XFStyle()
